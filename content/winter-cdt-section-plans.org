...
#+PROPERTY: SUMMARY Section-by-section route plans for winter Continental Divide ski traverse with timing, distance, and terrain details for each segment.
#+LANGUAGE: en
#+OPTIONS: ^:nil toc:nil

* Introduction

I list a rough time plan for my northbound ski traverse along the
